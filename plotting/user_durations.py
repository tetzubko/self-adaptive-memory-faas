...
axs[0].plot(data_user['Request Duration'], color="#0065bd")
axs[0].set_ylabel('Duration (ms)')

axs[1].plot(data_aws['Allocated Memory'], color="#e37222")
...
plt.savefig("../../images/5_user_side.png", format='png', dpi=300, bbox_inches='tight')
plt.show()
